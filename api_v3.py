...
parser.add_argument("-w", "--workers", type=int, default=10, help="default: 10")
...
""" START | TTS CONFIG , SO DOES NOT CRASH """
...
def init_models():
    ...
    print(tts_config)
    tts_pipeline = TTS(tts_config)
""" FINISH |TTS CONFIG , SO DOES NOT CRASH """
...
if __name__ == "__main__":
    ...
    multiprocessing.set_start_method("spawn", force=True) # Forces fresh processes
    try:
